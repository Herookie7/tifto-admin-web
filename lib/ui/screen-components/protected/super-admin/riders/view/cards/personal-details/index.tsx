...
// Components
import { ResetPasswordDialog } from '@/lib/ui/useable-components/reset-password-dialog';
  ...
  return (
    <>
      <div className="flex flex-col gap-2 border rounded-lg overflow-hidden">
        <header className="bg-[#F4F4F5] px-6 py-3 border-b-[1px] text-lg font-medium flex justify-between items-center">
          <span>{t('Rider Information')}</span>
          {!loading && rider?.email && (
            <Button
